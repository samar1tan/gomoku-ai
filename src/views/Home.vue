  ...
  <div class="home">
    ...
    <div class="weui-flex operations">
      <div class="weui-flex__item">
        <a
          href="javascript:"
          :class="'weui-btn weui-btn_primary ' + (status === 'LOADING' ? '' : 'weui-btn_disabled')"
          @click="showChooseAlgorithmDialog">
          {{$t('algorithm')}}
        </a>
      </div>
      <div class="weui-flex__item">
    ...
    <Dialog
      ...
      <a href="javascript:" class="weui-dialog__btn weui-dialog__btn_primary" @click="start(1)">{{$t('dialog.computer')}}</a>
    </Dialog>
    <Dialog
      ref="give"
    ...
    <Dialog
      ref="algorithm"
      :title="$t('dialog.chooseAlgorithmTitle')"
      :body="$t('dialog.chooseAlgorithmBody')"
    >
      <a href="javascript:" class="weui-dialog__btn weui-dialog__btn_primary" @click="chooseAlgorithm('greedy')">{{$t('dialog.greedy')}}</a>
      <a href="javascript:" class="weui-dialog__btn weui-dialog__btn_primary" @click="chooseAlgorithm('minimax')">{{$t('dialog.minimax')}}</a>
    </Dialog>
